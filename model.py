...
#A convolutional neural network architecture for classifying radar data
    ...
    def train_neural_network(self, session, optimizer, dropout_p, feature_batch, label_batch):
    ...
    def print_stats(self, session, feature_batch, label_batch, cost, accuracy):
        loss = session.run(cost, feed_dict={x: feature_batch, y: label_batch, dropout_p: 1.})
